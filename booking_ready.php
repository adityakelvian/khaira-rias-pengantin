...
$tgl=date('Y-m-d');
//insert
$sql 	= "INSERT INTO booking (kode_booking,id_jasa,ukuran,tgl_mulai,tgl_selesai,durasi,status,email,pickup,tgl_booking)
...
if($query){
	for($cek;$cek<$durasi;$cek++){
		...
		$sql1	="INSERT INTO cek_booking (kode_booking,id_jasa,ukuran,tgl_booking,status)VALUES('$kode','$id','$size','$tglhasil','$status')";
		$query1 = mysqli_query($koneksidb,$sql1);
	}
	echo " <script> alert ('Produk atau Layanan berhasil disewa.'); </script> ";
...
$sql1 	= "SELECT jasa.*,jenis.* FROM jasa,jenis WHERE jasa.id_jasa=jenis.id_jenis and jasa.id_jasa='$id'";
$query1 = mysqli_query($koneksidb,$sql1);
