...
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*, wedding_org.*, jenis.*, member.* FROM booking, wedding_org, jenis, member WHERE booking.id_jasa=wedding_org.id_jasa 
			AND jasa.id_jenis=jenis.id_jenis and booking.email=member.email and booking.kode_booking='$kode'";
			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>KhairaRiasPengantin.com</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 823-2275-3411 | E-mail : ask@sewabaju.com</td>
					</tr>
					<tr>
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Baju</td>
						<td>:</td>
						<td><?php echo $result['nama_jasa'];?></td>
					</tr>
					<tr>
						<td>Tanggal Mulai</td>
						<td>:</td>
