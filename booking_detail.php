...
<?php 
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,wedding_org.*, jenis.* FROM booking,wedding_org,jenis WHERE booking.id_jasa=wedding_org.id_jasa AND wedding_org.id_jenis=jenis.id_jenis AND booking.kode_booking='$kode'";
...
<section class="user_profile inner_pages">
			<center><h3>Detail Pemesanan</h3></center>
	<div class="container">
	<div class="user_profile_info">	
		<div class="col-md-12 col-sm-10">
        <form method="post" name="sewa" onSubmit="return valid();"> 
			<input type="hidden" class="form-control" name="id"  value="<?php echo $result['id_jasa'];?>"required>
            ...
            <div class="form-group">
			<label>Biaya Pemesanan (<?php echo $durasi;?> Hari)</label><br/>
			...
			<?php if($result['status']=="Menunggu Pembayaran"){
				...
				?>
			<b>*Silahkan transfer total biaya Pemesanan ke <?php echo $resultrek['detail'];?> maksimal tanggal <?php echo IndonesiaTgl($tglhasil);?>.
			<?php
			}else{
